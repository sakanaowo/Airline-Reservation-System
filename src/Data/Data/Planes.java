...
public class Planes {
    ...
    public static void updatePlaneBaseOnFlight() {
        ...
        try (Connection connection = DriverManager.getConnection(
                CommonConstants.DB_URL, CommonConstants.DB_USERNAME, CommonConstants.DB_PASSWORD);
             PreparedStatement updatePlanesStmt = connection.prepareStatement(updatePlanesSQL);
             PreparedStatement deleteTicketsStmt = connection.prepareStatement(deleteTicketsSQL);
